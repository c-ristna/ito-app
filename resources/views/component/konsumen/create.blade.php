        ...
        <section class="base">
          <div class="form">
            <div>
              ...
              <input type="text" id="form-control" name="kode_konsumen" autofocus="" required="" placeholder="Ketik disini" />
            </div>
            <div>
              <label class="form-label">Nama Konsumen</label>
              <input type="text" id="form-control" name="nama_konsumen" autofocus="" required="" placeholder="Ketik disini" />
            </div>
            <div>
